...
namespace lve{
  ...
  void LvePipeline::createGraphicsPipline(
    ...
    PipelineConfigInfo LvePipeline::defaultPipelineConfigInfo(uint32_t width, uint32_t height){
      ...
      // Transforms GL position values to pixels on the display.
      ...
      configInfo.rasterizationInfo.depthBiasConstantFactor = 0.0f;    // Not currently in use
      configInfo.rasterizationInfo.depthBiasClamp = 0.0f;             // Not currently in use
